...
int main(int argc, char *argv[]) {
    ...
    MPI_Request req[2];
    MPI_Isend(message.data(), numElements, MPI_INT, destination, rank+1, MPI_COMM_WORLD, &req[0]);
    ...
    MPI_Irecv(receiveBuffer.data(), numElements, MPI_INT, source, rank, MPI_COMM_WORLD, &req[1]);
