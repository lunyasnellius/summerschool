...
Below you’ll find a few statements about parallel scaling. Which of the statements are true?
...
Below is scalability data from four different parallel programs. Which of the programs is the most efficient?

1. Strong scaling efficieny of 78 % from 10 to 100 nodes
2. Weak scaling efficiency of 88 % from 6 to 600 nodes
3. Speedup of 7x from 8 to 64 nodes
4. Strong scaling effiecieny of 55 % from 4 to 8 nodes
